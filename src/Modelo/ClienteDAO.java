...
public class ClienteDAO {
 ...
 public ResultSet clientesPorLotes(){
     ...
     try {
          ...
          String listar = "SELECT c.Dni, c.Apellidos, c.Nombres,c.barrio, c.calle, c.numero, c.Telefono1, c.trabajo, f.Id_control, f.cantidad_cuotas, f.gastos, f.bolsa_cemento, f.Barrio, f.Manzana, f.Parcela FROM cliente c LEFT JOIN ficha_control f ON c.Dni = f.Dni"; 
